...
<body>
    <nav><a href="01_logout.php">登出</a></nav>
    <h1>會員中心</h1>
    ...
    <button><a href='edit.php?id=<?=$user['id'];?>'>編輯會員資料a標籤</a></button>
    ...
    <!-- 未帶值 -->
    <button onclick="location.href='edit.php'">編輯會員資料js-location未帶值</button>
    <!-- 帶值 方法和a標籤相同 -->
    <button onclick="location.href='edit.php?id=<?=$user['id'];?>'">編輯會員資料js-location帶值</button>
